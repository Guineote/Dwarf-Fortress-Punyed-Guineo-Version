...
class ColonyDwarves:
    ...
    def create_visuals(self, base_pos):
        ...
        for i, dwarf_data in enumerate(self.dwarves):
            ...
            # Crea el sprite pasando name y strength desde DwarfData
            dwarf_sprite = Dwarf(pos, self.colony, self,name=dwarf_data.name, strength=dwarf_data.stats["strength"])
    ...
    def get_idle_dwarves(self):
        ...
        return [d for d in self.dwarves if not d.is_busy]