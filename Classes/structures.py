...
class House(Structure, pygame.sprite.Sprite): 
    def __init__(self, house_id: int, pos, colony_dwarves):
        materials = {
            "wood": 20,
            "stone": 10,
            "iron": 5
        ...
        Structure.__init__(self, name, StructureType.HOUSE, materials, capacity=4)  
        pygame.sprite.Sprite.__init__(self) 
        
        self.image = pygame.image.load('Assets/Img/house.png').convert_alpha()
